...
def main():
    ...
    for scanno in range(nscans):
        ...
        if use_odometry:
            ...
            velocities = robot.computePoseChange(odometries[scanno][0], odometries[scanno][1], odometries[scanno][2])
    ...
    for coords in trajectory:
        ...
        print(y_pix, MAP_SIZE_PIXELS, x_pix)
        if y_pix >= 0 and x_pix >=0:
