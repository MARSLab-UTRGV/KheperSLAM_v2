...
#ifndef OFFLINE_SLAM_H
#define OFFLINE_SLAM_H
 ...
 */
class CKheperaIVManualControl : public CCI_Controller {
...
public:
    ...
    * file, under the
    * <controllers><Khepera_manualcontrol_controller><parameters><wheel_turning>
    * section.
    */
...
public:
   ...
   /* Class constructor. */
   CKheperaIVManualControl();

   /* Class destructor. */
   virtual ~CKheperaIVManualControl() {}

   /*
    * This function initializes the controller.
    * The 't_node' variable points to the <parameters> section in the XML file
    * in the <controllers><Khepera_manualcontrol_controller> section.
    */
