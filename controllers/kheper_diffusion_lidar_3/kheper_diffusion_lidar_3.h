...
#ifndef KHEPER_DIFFUSION_LIDAR_H
#define KHEPER_DIFFUSION_LIDAR_H
...
/* Definintion of the generic differential steering */
 ...
 */
class CKheperDiffusionLidar3 : public CCI_Controller {
...
public:
   ...
   /* Class constructor. */
   CKheperDiffusionLidar3();

   /* Class destructor. */
   virtual ~CKheperDiffusionLidar3() {}
...
private:
   ...
   /* Pointer to the kheperaiv proximity sensor */
   CCI_KheperaIVProximitySensor* m_pcProximity;
    /* Pointer to the differential steering sensor */
       CCI_DifferentialSteeringSensor* m_pcOdometry;

    /* odom readings */
    Real m_leftOdom = 0.0;
    Real m_rightOdom = 0.0;

    /* Pointer to the kheperaiv lidar sensor */
   CCI_KheperaIVLIDARSensor* m_pcLidar;
   /* The turning parameters */
   SWheelTurningParams m_sWheelTurningParams;
    /* file handler for real data */
   std::ofstream m_cSLAMData;
    /* file for test data */
   std::ofstream m_cTestData;
