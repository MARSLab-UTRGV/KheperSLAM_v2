...
#include "kheper_diffusion_lidar_3.h"
...
CKheperDiffusionLidar3::CKheperDiffusionLidar3() :
   m_pcWheels(NULL),
  m_pcOdometry(NULL),
  m_pcLidar(NULL),
  m_cSLAMData("kheper_data_3.dat", std::ofstream::out | std::ofstream::trunc),
...
void CKheperDiffusionLidar3::Init(TConfigurationNode& t_node) {
   /*
...
void CKheperDiffusionLidar3::ControlStep() {
 ...
 */
REGISTER_CONTROLLER(CKheperDiffusionLidar3, "kheper_diffusion_lidar_controller_3")
