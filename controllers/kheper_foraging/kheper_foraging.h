...
#include <argos3/plugins/robots/kheperaiv/control_interface/ci_kheperaiv_motor_ground_sensor.h>
 ...
 */
class CKheperaIVForaging : public CCI_Controller {
...
private:
   ...
   CCI_KheperaIVMotorGroundSensor* m_pcGround;
