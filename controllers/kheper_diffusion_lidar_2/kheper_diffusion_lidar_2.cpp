...
#include "kheper_diffusion_lidar_2.h"
...
CKheperDiffusionLidar2::CKheperDiffusionLidar2() :
   m_pcWheels(NULL),
  m_pcOdometry(NULL),
  m_pcLidar(NULL),
  m_cSLAMData("kheper_data_2.dat", std::ofstream::out | std::ofstream::trunc),
...
void CKheperDiffusionLidar2::Init(TConfigurationNode& t_node) {
   /*
...
void CKheperDiffusionLidar2::ControlStep() {
 ...
 */
REGISTER_CONTROLLER(CKheperDiffusionLidar2, "kheper_diffusion_lidar_controller_2")
